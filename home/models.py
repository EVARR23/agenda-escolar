...
class Crianca(models.Model):
    ...
    mor_q = models.CharField(max_length=200,  choices=AVOS_OU_PAIS_OU_TIOS, verbose_name="Mora com quem?")
    irm = models.CharField(max_length=3, choices=SIM_OU_NAO, verbose_name="Tem irmãos?")
    pr_sau = models.CharField(max_length=200, choices=SIM_OU_NAO, verbose_name="prob saúde")
    med = models.CharField(max_length=200,  choices=SIM_OU_NAO, verbose_name = "Medic continuo?")
    med_q = models.CharField(max_length=50,verbose_name="Medic qual?")
    aler = models.CharField(max_length=200,  choices=SIM_OU_NAO,verbose_name="tem_alergias?")
    aler_q = models.CharField(max_length=200, verbose_name="aler_qual?")
    resp = models.ForeignKey('Responsavel', on_delete=models.CASCADE, related_name='criancas', verbose_name="responsável")
